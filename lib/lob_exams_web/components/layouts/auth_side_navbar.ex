defmodule LobExamsWeb.Layouts.AdminSideNav do
  ...
  def admin_side_nav(assigns) do
    ...
    ~H"""
    <!-- Sidebar -->
      <div class="hidden md:w-64 md:bg-gray-800 border-r border-gray-700 md:flex md:flex-col">
        ...
        <nav class="flex-1 p-4 space-y-2">
          ...
          <a href="#" class="flex items-center space-x-2 px-3 py-2 rounded text-gray-300 hover:bg-gray-700">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
